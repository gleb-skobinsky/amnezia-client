...
struct Log {
  private static let subsystemIdentifier = Bundle.main.bundleIdentifier ?? "org.amnezia.AmneziaVPNBeta"
  ...
  private static let appGroupID = "group.org.amnezia.AmneziaVPNBeta"
